...
> **最后更新**: 2026-03-18（修复BUG-015：DELETE操作404错误）
> **更新者**: Claude Sonnet 4.5
> **当前分支**: develop
> **最新commit**: d70f0d5 (fix(task): 修复DELETE操作404错误 - 后端返回已软删除任务导致缓存污染)
> **Git状态**: ✅ 已提交
...
### BUG-007、BUG-008、BUG-009、BUG-010修复：选项2关键BUG ✅
...
9. ✅ **BUG-015**: DELETE操作404错误 - 已修复（2026-03-18, commit d70f0d5）⭐ 新增
   - **根本原因**：后端getTasksByDate()查询重复任务时，未正确应用Sequelize paranoid过滤，返回已软删除任务
   - **修复内容**：
     1. 后端taskService.js:123 - 显式添加 `deletedAt: null` 过滤条件
     2. 前端task.js:263-266 - 添加deletedAt防御性检查
   - **分析文档**：`docs/06-AI协作日志/BUG-015-删除无分类任务失败分析.md`
